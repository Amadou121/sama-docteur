        ...
        <div class="col-lg-3 mb-4" data-aos="fade-right">
            <div class="dashboard-sidebar">
                ...
                <ul class="dashboard-menu">
                    <li>
                        <a href="medecins.php" class="<?php echo !$specialite ? 'active' : ''; ?>">
                            <i class="fas fa-list"></i> Toutes les spécialités
                        </a>
                    </li>
                    <?php foreach($specialites as $spec): ?>
                    <li>
                        <a href="medecins.php?specialite=<?php echo urlencode($spec['nom']); ?>" class="<?php echo $specialite == $spec['nom'] ? 'active' : ''; ?>">
            ...
            <div class="dashboard-sidebar mt-4">
                ...
                <form method="GET" action="" id="filterForm">
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="specialite" value="<?php echo htmlspecialchars($specialite); ?>" placeholder="Rechercher...">
                    </div>
                    <div class="mb-3">
                    ...
                    <?php if($specialite || $ville): ?>
                    <a href="medecins.php" class="btn btn-outline-secondary w-100 mt-2">
                    ...
                    <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="<?php echo $index * 50; ?>">
                        <div class="card-medecin card h-100">
                            ...
                            <div class="card-body">
                                ...
                                <p class="info"><i class="fas fa-map-marker-alt"></i> <?php echo htmlspecialchars($medecin['ville'] ?: 'Saint-Louis'); ?>, Sénégal</p>
